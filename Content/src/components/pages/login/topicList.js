...
import { View, ScrollView, StyleSheet, Text, TextInput, Dimensions, TouchableOpacity, Alert } from 'react-native';
...
const TopicList = (props) => {
	...
	const selectTopic = (index, evt) => {
		...
		//Alert.alert(topic.length.toString());
	};
			...
			<ScrollView style={{ marginBottom: 50 }}>
				<View style={styles.container}>
								...
								<TouchableOpacity onPress={selectTopic.bind(this, Topic)}>
									<View
										style={{
											...styles.boxSimple,
											marginLeft:
												Topic.number % 2 == 0 ? Dimensions.get('window').width * 0.025 : 0
										}}
									>
										<LinearGradient
											colors={[
					...
					{user.isAdmin ? (
						<View
							style={{
								...styles.boxSimple,
								marginLeft: Topics.length % 2 == 1 ? Dimensions.get('window').width * 0.025 : 0
							}}
						>
							{!addMode ? (
								...
								<View>
									...
									<View flexDirection="row" style={styles.boxRightOptions}>
										<TouchableOpacity
											...
											style={{
												...styles.icon,
												backgroundColor: inRequest || !newCategory ? '#6ae7b5' : '#1fc281'
											}}
										>
				...
				<PButton
					...
					viewStyle={{
						...
						backgroundColor: selectedTopic.length === 0 ? '#5aa0ff' : Constants.textColor1
					}}
