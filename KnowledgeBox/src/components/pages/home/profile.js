...
const Profile = (props) => {
	return (
		<ContainerList title="My Profile" onPress={() => props.navigation.navigate('HomeTab')}>
			<ScrollView style={{ backgroundColor: 'white' }}>
				...
				<View style={styles.containerText}>
					...
					<Text style={styles.textObject}>{global.user.firstName || global.user.firstname}</Text>
				</View>
				<View style={styles.containerText}>
					<Text style={styles.textField}>Last Name:</Text>
					<Text style={styles.textObject}>{global.user.lastName || global.user.lastname}</Text>
				</View>
				<View style={styles.containerText}>
				...
				<View style={styles.containerText}>
					...
					<Text style={styles.textObject}>
						{global.user.phone || global.user.phoneNumber || global.user.phonenumber}
					</Text>
				</View>
			</ScrollView>
		</ContainerList>
...
const styles = StyleSheet.create({
	...
	textField: { color: Constants.textColor1, fontSize: 14 },
	textObject: { marginTop: 5, color: Constants.textColor1, fontSize: 18 }
});
